...
(function () {
  function init() {
    ...
    function scrollFirstInvalid(scope) {
      var el = scope.querySelector('.wo-q-invalid');
    ...
    function bookingParams(kind, eventTypeUri, startTime, answers) {
